...
document.addEventListener('alpine:init', function() {
  ...
  Alpine.store('app', {
    ...
    toggleFocusMode() {
      ...
      localStorage.setItem('openclaw-focus', this.focusMode);
    },
    ...
    async checkStatus() {
      try {
        ...
        console.warn('[OpenClaw] Status check failed:', e.message);
      }
    },
  ...
  // Listen for gateway connection state changes
...
function app() {
  return {
    page: 'agents',
    themeMode: localStorage.getItem('openclaw-theme-mode') || 'system',
    theme: (() => {
      var mode = localStorage.getItem('openclaw-theme-mode') || 'system';
      if (mode === 'system') return window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light';
      return mode;
    })(),
    sidebarCollapsed: localStorage.getItem('openclaw-sidebar') === 'collapsed',
    ...
    setTheme(mode) {
      this.themeMode = mode;
      localStorage.setItem('openclaw-theme-mode', mode);
      if (mode === 'system') {
    ...
    toggleSidebar() {
      ...
      localStorage.setItem('openclaw-sidebar', this.sidebarCollapsed ? 'collapsed' : 'expanded');
    },
